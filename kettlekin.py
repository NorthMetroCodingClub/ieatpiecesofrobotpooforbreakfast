...
class Robot:
    ...
    def __initialize_robots(self, game):
        for robot in game['robots'].itervalues():
            ...
            if robot.player_id == self.player_id:
                ...
                # Can clean this up to avoid repeating crap.
    ...
    def __cautious_move(self, game, move_location):
        # Todo: expand on this.
        # First, let's not allow our guys to move back onto a spawn
        # location once they've moved inwards.
        ...
        # work out, could be that we collided.  Let's just chill for a turn and
        ...
        # Dammit, looks like we're moving to the requested location.
...
# How about adding HP history to this bitch? 
